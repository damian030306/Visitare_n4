...
using Visitare_n1.Providers;
using Visitare_n1.Results;
...
namespace Visitare_n1.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        //    ApplicationUserModel user = await UserManager.FindAsync(new UserLoginInfo(externalLogin.LoginProvider,
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            var user = new ApplicationUserModel() { UserName = model.Nickname, Email = model.Email };
